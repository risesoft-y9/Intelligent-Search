...
import dataWhitelistRouter from './modules/dataWhitelistRouter';
import dataSupervisionRouter from './modules/dataSupervisionRouter';
import operationLogRouter from './modules/operationLogRouter';
import searchTermManageRouter from './modules/searchTermManageRouter';
...
export const asyncRoutes = [dataWhitelistRouter, dataSupervisionRouter, operationLogRouter, searchTermManageRouter];
// 引入其他模块路由
