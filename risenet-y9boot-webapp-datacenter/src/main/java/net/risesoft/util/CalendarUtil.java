...
public class CalendarUtil {
	 ...
	 * @return
	 */
	public static List<String> getLastFiveYearsTime(){
		List<String> list = new ArrayList<>();
		try {
			Calendar instance = Calendar.getInstance();
		    String currentYear = instance.get(Calendar.YEAR) + "-12";
		    instance.add(Calendar.YEAR,-5);
		    String beforeFiveYear = instance.get(Calendar.YEAR) + "-01";
		    list.add(beforeFiveYear);
