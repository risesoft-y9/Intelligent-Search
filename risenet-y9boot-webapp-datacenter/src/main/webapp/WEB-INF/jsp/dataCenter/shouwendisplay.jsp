	    ...
	    <div class="db_main_left" id="db_main_left">
	        <div class="db_txt" id="db_txt">
				...
				<table cellpadding="0" cellspacing="0" style="border: 0px solid;margin-bottom: 10px;width: 100%;">
					<tbody>
						<tr>
							<td align="center" height="35" width="150" style="color: #999">来文单位</td>
							<td align="left" width="400">${info.laiwenjiguan }</td>
							<td align="center" height="35" width="150" style="color: #999">收文编号</td>
							<td align="left" width="400">${info.jjgshouwenbianhao }</td>
						</tr>
						<tr>
							<td align="center" height="35" width="150" style="color: #999">登记时间</td>
							<td align="left" width="400">${info.dengjishijian }</td>
							<td align="center" height="35" width="150" style="color: #999">密&nbsp;&nbsp;级</td>
							<td align="left" width="400">${info.miji }</td>
						</tr>
						<tr>
		        ...
		        <div class="annex">
			        <ul>
			        	<c:if test="${empty info.attachments }">
						...
						<c:if test="${not empty info.attachments }">
				        	<c:forEach items="${info.attachments }" var="file" varStatus="status">
				        		<li>
					                ...
					                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					                <a href="javascript:void(0);" onclick="openFile('${info.id}','${file.fileName }');" title="点击预览" style="color: #00000085;" >预览</a>
					            </li>
				        	</c:forEach>
			        	</c:if> 
			        </ul>
...
<script type="text/javascript">
	...
	function openFile(id, fileName){
        var url = "${ctx}/pdf/index?id="+encodeURI(id)+"&fileName="+encodeURI(fileName);
        window.open(url);
 	}
