	    ...
	    <div class="db_main_left" id="db_main_left">
	        <div class="db_txt" id="db_txt">
				...
				<table cellpadding="0" cellspacing="0" style="border: 0px solid;margin-bottom: 10px;width: 100%;">
					<tbody>
						<tr>
							<td align="center" height="35" width="150" style="color: #999">主&nbsp;&nbsp;送</td>
							<td align="left" width="400">${info.zhusong }</td>
							<td align="center" height="35" width="150" style="color: #999">抄&nbsp;&nbsp;送</td>
							<td align="left" width="400">${info.chaosong }</td>
						</tr>
						<tr>
							<td align="center" height="35" width="150" style="color: #999">公平性审查</td>
							<td align="left" width="400">${info.gpxsc }</td>
							<td align="center" height="35" width="150" style="color: #999">保密审查</td>
							<td align="left" width="400">${info.baomishencha }</td>
						</tr>
						<tr>
							<td align="center" height="35" width="150" style="color: #999">信息公开性</td>
							<td align="left" width="400">${info.dx9 }</td>
							<td align="center" height="35" width="150" style="color: #999">不予公开原因</td>
							<td align="left" width="400">${info.dx }</td>
						</tr>
						<tr>
							<td align="center" height="35" width="150" style="color: #999">拟稿单位</td>
							<td align="left" width="400">${info.nigaodanwei }</td>
							<td align="center" height="35" width="150" style="color: #999">拟稿人</td>
							<td align="left" width="400">${info.nigaoren }</td>
						</tr>
						<tr>
							<td align="center" height="35" width="150" style="color: #999">处室负责人</td>
							<td align="left" width="400">${info.chushifuzeren }</td>
							<td align="center" height="35" width="150" style="color: #999">校&nbsp;&nbsp;对</td>
							<td align="left" width="400">${info.jiaodui }</td>
						</tr>
						<tr>
						...
						<tr>
							<td align="center" height="35" width="150" style="color: #999">份&nbsp;&nbsp;数</td>
							<td align="left" colspan="3">${info.fenshu }</td>
						</tr>
					</tbody>
				</table>
				<div class="para-title level-2">
